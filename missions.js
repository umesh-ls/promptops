    ...
    missions: [
      ...
      },
      {
        ...
        questions: [
          ...
          { text: 'Which homework task is SAFEST to do with AI without external verification?', options: ['Getting exact dates for a history timeline', "Having a concept explained until you understand it", 'Getting statistics for a science report', 'Getting quotes from a famous person'], correct: 1, why: "Explanations of well-known concepts are the model's strength — and you can test understanding yourself. Dates, stats and quotes are specific facts: verify before using." },
        ],
      },
      {
